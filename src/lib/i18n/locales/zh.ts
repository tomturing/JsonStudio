export default {
  ...
  // JSONL View
  'jsonl.title': 'JSONL 数据视图',
  'jsonl.untitledHint': '按行查看每条 JSON 记录',
  'jsonl.openSource': '查看原文',
  'jsonl.backToView': '返回数据视图',
  'jsonl.sourceModeHint': '正在编辑 JSONL 原文，保存时保留每行记录格式。',
  'jsonl.valid': '有效',
  'jsonl.errors': '错误',
  'jsonl.parsingHint': '正在按行解析数据...',
  'jsonl.parseFailed': 'JSONL 解析失败',
  'jsonl.searchPlaceholder': '搜索行内容或字段...',
  'jsonl.clearSearch': '清除搜索',
  'jsonl.filterLabel': '记录筛选',
  'jsonl.all': '全部',
  'jsonl.fieldFilterLabel': '字段条件筛选',
  'jsonl.fieldSelectLabel': '字段',
  'jsonl.fieldOperatorLabel': '条件',
  'jsonl.fieldValueLabel': '字段值',
  'jsonl.allFields': '选择字段',
  'jsonl.fieldValuePlaceholder': '输入值...',
  'jsonl.clearFieldFilter': '清除字段筛选',
  'jsonl.operator.equals': '=',
  'jsonl.operator.notEquals': '!=',
  'jsonl.operator.contains': '包含',
  'jsonl.operator.notContains': '不包含',
  'jsonl.noRecords': '暂无 JSONL 记录',
  'jsonl.noRecordsHint': '每一行需要是一个独立的 JSON 值。',
  'jsonl.noMatches': '没有匹配记录',
  'jsonl.noMatchesHint': '可以清除搜索或切换筛选条件。',
  'jsonl.tableLabel': 'JSONL 记录表',
  'jsonl.invalid': '无效 JSON',
  'jsonl.column': '第',
  'jsonl.details': '展开的 JSON 记录',
  'jsonl.paginationLabel': 'JSONL 分页',
  'jsonl.previousPage': '上一页',
  'jsonl.nextPage': '下一页',
  'jsonl.pageCurrentPrefix': '',
  'jsonl.pageCurrentSuffix': '页',
  'jsonl.pageTotal': '{total}',
  'jsonl.pageInputLabel': '页码',
  'jsonl.pagePlaceholder': '页码',
  'jsonl.pageSizeLabel': '每页',
  'jsonl.pageSizeOption': '每页 {count} 条',
  'jsonl.copyRow': '复制原行',
  'jsonl.copySuccess': 'JSONL 原行已复制',
  'jsonl.copyFailed': '复制 JSONL 原行失败',
  'jsonl.expandAll': '全部展开',
  'jsonl.collapseAll': '全部折叠',
  'jsonl.expandNode': '展开 JSON 节点',
  'jsonl.collapseNode': '折叠 JSON 节点',
} as const;
