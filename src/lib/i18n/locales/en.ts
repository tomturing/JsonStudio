export default {
  ...
  // JSONL View
  'jsonl.title': 'JSONL Data View',
  'jsonl.untitledHint': 'Inspect one JSON record per line',
  'jsonl.openSource': 'View source',
  'jsonl.backToView': 'Back to data view',
  'jsonl.sourceModeHint': 'Editing JSONL source. Saving keeps the one-record-per-line format.',
  'jsonl.valid': 'valid',
  'jsonl.errors': 'errors',
  'jsonl.parsingHint': 'Parsing records line by line...',
  'jsonl.parseFailed': 'JSONL parsing failed',
  'jsonl.searchPlaceholder': 'Search rows or fields...',
  'jsonl.clearSearch': 'Clear search',
  'jsonl.filterLabel': 'Record filter',
  'jsonl.all': 'All',
  'jsonl.fieldFilterLabel': 'Field filter',
  'jsonl.fieldSelectLabel': 'Field',
  'jsonl.fieldOperatorLabel': 'Field operator',
  'jsonl.fieldValueLabel': 'Field value',
  'jsonl.allFields': 'Choose a field',
  'jsonl.fieldValuePlaceholder': 'Value...',
  'jsonl.clearFieldFilter': 'Clear field filter',
  'jsonl.operator.equals': '=',
  'jsonl.operator.notEquals': '!=',
  'jsonl.operator.contains': 'contains',
  'jsonl.operator.notContains': 'not contains',
  'jsonl.noRecords': 'No JSONL records',
  'jsonl.noRecordsHint': 'Each line must contain one independent JSON value.',
  'jsonl.noMatches': 'No matching records',
  'jsonl.noMatchesHint': 'Clear the search or change the record filter.',
  'jsonl.tableLabel': 'JSONL record table',
  'jsonl.invalid': 'Invalid JSON',
  'jsonl.column': 'Col',
  'jsonl.details': 'Expanded JSON record',
  'jsonl.paginationLabel': 'JSONL pagination',
  'jsonl.previousPage': 'Previous',
  'jsonl.nextPage': 'Next',
  'jsonl.pageCurrentPrefix': '',
  'jsonl.pageCurrentSuffix': ' Page',
  'jsonl.pageTotal': '{total}',
  'jsonl.pageInputLabel': 'Page number',
  'jsonl.pagePlaceholder': 'Page',
  'jsonl.pageSizeLabel': 'Rows per page',
  'jsonl.pageSizeOption': '{count} / page',
  'jsonl.copyRow': 'Copy source row',
  'jsonl.copySuccess': 'JSONL source row copied',
  'jsonl.copyFailed': 'Failed to copy JSONL source row',
  'jsonl.expandAll': 'Expand all',
  'jsonl.collapseAll': 'Collapse all',
  'jsonl.expandNode': 'Expand JSON node',
  'jsonl.collapseNode': 'Collapse JSON node',
} as const;
